...
# with command line options: step3 --filein file:step2.root --fileout file:step3.root --mc --eventcontent AODSIM runUnscheduled --datatier AODSIM --conditions 94X_mc2017_realistic_v10 --step RAW2DIGI,RECO,RECOSIM,EI --nThreads 8 --era Run2_2017 --python_filename step3.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
