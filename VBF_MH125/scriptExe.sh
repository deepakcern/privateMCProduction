...
#echo "================= CMSRUN setting up CMSSW_9_3_7 ===================="| tee -a job.log
...
# cp -v $BASE/HIG-PhaseIISummer17wmLHEGENOnly-00020-fragment.py  Configuration/GenProduction/python/

# scram b
#cd $BASE

echo "================= CMSRUN starting Step 1 ====================" | tee -a job.log
cmsRun -j GenSimAODSim_step1.log step1.py jobNum=$10
