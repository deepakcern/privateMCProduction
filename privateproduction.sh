...
export GRIDPACKLOC=/afs/cern.ch/work/d/dekumar/public/zoheb/VBF_H/VBF_H_slc6_amd64_gcc630_CMSSW_9_3_0_test_AllInOneVBF_H_NNPDF30_14TeV_M125.tgz
...
cp $WORKDIR/run_generic_tarball_cvmfs.sh GeneratorInterface/LHEInterface/data/run_generic_tarball_cvmfs.sh

echo "Change number of events in python config to"
echo $NUMBEREVENTS
sed -e "s/#NUMBEREVENTS#/${NUMBEREVENTS}/g" $WORKDIR/pythonLHEGEN_cfg_draft.py > ./pythonLHEGEN_cfg_eventsInserted.py
